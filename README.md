...
- Update `benchmark_mongo.py` and `benchmark_mysql.py` to use your secure password
  - Also update `load_to_mongodb.py`
- Run `_run.py`
...
Once complete, the results are saved locally and the created instances are automatically destroyed.
